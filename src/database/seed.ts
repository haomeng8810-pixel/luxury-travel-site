  ...
  const destinations = await Promise.all([
    prisma.destination.upsert({
      ...
      create: {
        ...
        continent: 'Asia',
        region: '关东',
        highlight: JSON.stringify(['浅草寺', '东京塔', '涩谷十字路口', '新宿御苑']),
        language: 'Japanese',
        isActive: true,
        sortOrder: 1,
      },
    ...
    prisma.destination.upsert({
      ...
      create: {
        ...
        continent: 'Asia',
        region: '关西',
        highlight: JSON.stringify(['金阁寺', '伏见稻荷大社', '园', '岚山']),
        language: 'Japanese',
        isActive: true,
        sortOrder: 2,
      },
    ...
    prisma.destination.upsert({
      ...
      create: {
        ...
        continent: 'Asia',
        region: '关西',
        highlight: JSON.stringify(['道顿堀', '大阪城', '环球影城']),
        language: 'Japanese',
        isActive: true,
        sortOrder: 3,
      },
    ...
    prisma.destination.upsert({
      ...
      create: {
        ...
        continent: 'Asia',
        region: '北海道',
        highlight: JSON.stringify(['富良野', '美瑛', '登别温泉', '函馆夜景']),
        language: 'Japanese',
        isActive: true,
        sortOrder: 4,
      },
    ...
    prisma.destination.upsert({
      ...
      create: {
        ...
        continent: 'Asia',
        region: '冲绳',
        highlight: JSON.stringify(['美丽海水族馆', '首里城', '万座毛']),
        language: 'Japanese',
        isActive: true,
        sortOrder: 5,
      },
  ...
  const trips = await Promise.all([
    prisma.trip.upsert({
      ...
      create: {
        ...
        categories: JSON.stringify(['Cultural', 'Wellness']),
        experiences: JSON.stringify(['Temple Visit', 'Tea Ceremony', 'Onsen']),
    ...
    prisma.trip.upsert({
      ...
      create: {
        ...
        categories: JSON.stringify(['Cultural', 'Nature']),
        experiences: JSON.stringify(['Hanami', 'Garden Visit', 'Photography']),
    ...
    prisma.trip.upsert({
      ...
      create: {
        ...
        categories: JSON.stringify(['Wellness', 'Luxury']),
        experiences: JSON.stringify(['Onsen', 'Spa', 'Meditation']),
        destinationId: destinations[3].id, // Hokkaido
        subDestinations: JSON.stringify(['登别', '箱根', '草津']),
        priceFrom: 45000,
        priceCurrency: 'CNY',
        priceNote: '每人价格，基于 2 人出行',
        isInquireOnly: true,
